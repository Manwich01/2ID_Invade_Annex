...

{
	...
	if (([_x, "gvs_veh"] call String_Search) == 0) then
	{
		...
		_act = format ["Public_gvs_veh_%1 = 1; publicVariable ""Public_gvs_veh_%1""; _nul = [""Public_gvs_veh_%1"", thislist, getPos thisTrigger, %2, %3, %4, %5, %6, %7] execVM ""scripts\gvs\generic_vehicle_service.sqf""", _veh, _veh_maxDistance, _veh_maxHeight, _veh_serviceStartDelay, _veh_per_fuel_time, _veh_per_repair_time, _veh_per_magazine_time];
	...
	if (([_x, "gvs_hel"] call String_Search) == 0) then
	{
		...
		_act = format ["Public_gvs_hel_%1 = 1; publicVariable ""Public_gvs_hel_%1""; _nul = [""Public_gvs_hel_%1"", thislist, getPos thisTrigger, %2, %3, %4, %5, %6, %7] execVM ""scripts\gvs\generic_vehicle_service.sqf""", _hel, _hel_maxDistance, _hel_maxHeight, _hel_serviceStartDelay, _hel_per_fuel_time, _hel_per_repair_time, _hel_per_magazine_time];
		_trg = createTrigger["EmptyDetector", _marPos];
	...
	if (([_x, "gvs_pla"] call String_Search) == 0) then
	{
		...
		_act = format ["Public_gvs_pla_%1 = 1; publicVariable ""Public_gvs_pla_%1""; _nul = [""Public_gvs_pla_%1"", thislist, getPos thisTrigger, %2, %3, %4, %5, %6, %7] execVM ""scripts\gvs\generic_vehicle_service.sqf""", _pla, _pla_maxDistance, _pla_maxHeight, _pla_serviceStartDelay, _pla_per_fuel_time, _pla_per_repair_time, _pla_per_magazine_time];
		_trg = createTrigger["EmptyDetector", _marPos];
	...
	if (([_x, "gvs_uav"] call String_Search) == 0) then
	{
		...
		_act = format ["Public_gvs_uav_%1 = 1; publicVariable ""Public_gvs_uav_%1""; _nul = [""Public_gvs_uav_%1"", thislist, getPos thisTrigger, %2, %3, %4, %5, %6, %7] execVM ""scripts\gvs\generic_vehicle_service.sqf""", _uav, _uav_maxDistance, _uav_maxHeight, _uav_serviceStartDelay, _uav_per_fuel_time, _uav_per_repair_time, _uav_per_magazine_time];
		_trg = createTrigger["EmptyDetector", _marPos];
